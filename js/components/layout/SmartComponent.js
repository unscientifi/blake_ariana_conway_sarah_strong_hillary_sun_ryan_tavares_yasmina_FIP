    ...
    <section class="container-xl testingPage">
        ...
        <div class="row">
            <div class="col-12" id="vidBox">
                <video poster="./images/play_smart_video_thumbnail.jpg" controls>
                    <source src="./video/play_smart.mp4" type="video/mp4">
            ...
            smart: [
                    {
                        ...
                        text: "The Centers for Disease Control and Prevention (CDC) recommends that everyone ages 13 to 64 should be tested for HIV. HIV testing is essential for slowing the spread of HIV infection. Many people are unaware that they have HIV, so they may be less likely to take precautions to help prevent spreading the virus to others. Additionally, early diagnosis can result in earlier treatment that may delay the progression to AIDS.",
                        text2: "Getting tested will relieve feelings of uncertainty and gives you a chance to learn about HIV and sexual risk reduction from a trained counselor.", 
                        graphic: "smart1.svg", 
                        alt: "graphic of an alarm clock that reads 'TE:ST'",
                        orderImg: "order-md-2",
                        orderText: "order-md-1",
                    },
                    {
                        title: "No studying required", 
                        text: "Testing is easy! HIV antibody tests will check your blood to see if your immune system has produced HIV antibodies. If they are present, it means you have been infected with HIV. These antibodies are unfortunately powerless in fighting off the virus, but their presence is enough to indicate if you have HIV or not." ,
                        text2: "Thankfully, there are no special preparations needed in order to test for HIV. You don't need to bring a health card to get tested at your local health unit. Testing at health units is confidential and your results will stay between you and your nurse, but will also be reported to the public health database as this is required in order for you to see a doctor who is experienced in providing HIV care.", 
                        graphic: "smart2.svg", 
                        alt: "graphic of a book, sample tubes, syringe, and blood",
                        orderImg: "order-md-1",
                        orderText: "order-md-2",
                    },
                    {
                        title: "Choose the option you're comfortable with", 
                        text: "When it comes to HIV testing, there are two types of tests available. Anonymous Testing doesn't require your name or health card. Instead the test is ordered using a six digit code. These tests are typically also rapid tests which are done on-site by sampling blood from a quick finger prick. You will receive results in about 20 minutes.", 
                        text2: "Confidential Testing is what you would get at a health unit or doctor's office. It uses your name and usually involves a standard blood draw. The results are sent to a lab so they will take longer to come back.", 
                        graphic: "smart3.svg", 
                        alt: "graphic of two sample tubes",
                        orderImg: "order-md-2",
                        orderText: "order-md-1",
                    },
                    {
                        ...
                        graphic: "smart4.svg", 
                        alt: "graphic of a person considering testing options",
